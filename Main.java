...
public class Main {
        public static void main(String[] args) {
                ...
                Materiel velo = new Materiel("Velo VTT", 250, 10, "Cyclisme", monMagasin, 10, 150, 100);
                Materiel tablePing = new Materiel("Table de ping-pong", 300, 12, "Ping-Pong", monMagasin, 25, 100, 100);
